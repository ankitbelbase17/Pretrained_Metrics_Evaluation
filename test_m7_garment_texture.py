...
def _probe_m7(device: str, batches: List[Dict[str, torch.Tensor]], _args) -> Tuple[Dict, str, float]:
...
def main() -> int:
    parser = argparse.ArgumentParser(description="M7 Garment Texture metric test across all configured datasets")
